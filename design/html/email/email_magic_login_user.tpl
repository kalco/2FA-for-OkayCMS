{* Passwordless / magic login email (frontend users) *}
{$subject = {$lang->rs__tfa__email_magic_subject} scope=global}

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <title>{$lang->rs__tfa__email_magic_subject}</title>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="es-p10t es-p15b" align="center">
                                                                <h1>{$lang->rs__tfa__email_magic_title} {$settings->site_name}</h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-p5t es-p5b es-p40r es-p40l" align="center">
                                                                <p>{$lang->rs__tfa__email_magic_desc} <strong>{$tfa_code_ttl_min} {$lang->rs__tfa__email_minutes}</strong>.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="es-p5t es-p5b es-p40r es-p40l" align="center">
                                                                <p style="color:#999999; font-size:12px;">
                                                                    {$lang->rs__tfa__email_magic_copy_link}<br>
                                                        ...
                                                        <tr>
                                                            <td class="es-p10t es-p5b es-p40r es-p40l" align="center">
                                                                <p style="color:#999999; font-size:12px;">{$lang->rs__tfa__email_magic_ignore}</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
